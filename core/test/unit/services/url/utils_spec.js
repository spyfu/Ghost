...
describe('Url', function () {
    ...
    describe('make absolute urls ', function () {
        ...
        it('[success] converts a relative URL', function () {
            ...
            result.should.match(/<a href="https:\/\/my-ghost-blog.com\/about#nowhere" title="Relative URL">/);
        });
        it('[success] converts a relative URL including subdirectories', function () {
            ...
            result.should.match(/<a href="https:\/\/my-ghost-blog.com\/blog\/about#nowhere" title="Relative URL">/);
        });
        ...
        it('asset urls only', function () {
            ...
            result.should.match(/<img src="https:\/\/my-ghost-blog.com\/content\/images\/1.jpg">/);
            ...
            result.should.match(/<a href="https:\/\/my-ghost-blog.com\/content\/images\/09\/01\/image.jpg">/);

            html = '<a href="/blog/content/images/09/01/image.jpg">';
            result = urlService.utils.makeAbsoluteUrls(html, siteUrl, itemUrl, {assetsOnly: true}).html();

            result.should.match(/<a href="https:\/\/my-ghost-blog.com\/blog\/content\/images\/09\/01\/image.jpg">/);
